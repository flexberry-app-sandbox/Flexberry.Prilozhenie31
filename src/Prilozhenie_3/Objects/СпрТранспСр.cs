    ...
    public class СпрТранспСр : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СпрТранспСрE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпрТранспСрE", typeof(IIS.Prilozhenie_3.СпрТранспСр));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СпрТранспСрL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпрТранспСрL", typeof(IIS.Prilozhenie_3.СпрТранспСр));
                }
            }
        }
    }
